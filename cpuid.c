...
Copyright 2024 AlpinDale

The original file is part of the MPIR Library.
...
#define FAKE_BUILD_CPU_VENDOR "MERSENNESNOTFAKE"
...
#define FAKE_FAT_CPU_VENDOR "MERSENNESNOTFAKE"
  ...
  if (strcmp (vendor_string, "GenuineIntel") == 0)
	...
	case 6:
	  ...
	  if (model == 60){
          ...
          if (model == 106){ CPUIS(icelake);break;}  // Icelake, e.g. Intel Xeon Gold 6342
     break;
   case 15:
